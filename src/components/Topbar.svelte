...
<div>
    ...
    <div class="flex flex-row justify-between items-center font-bold"> 
        ...
        <div class="space-x-2">
            ...
            <a href='https://github.com/sahilsait' target='_blank' rel='norefferer'><i class="fa-brands fa-github"></i></a>
            <a href='https://www.linkedin.com/in/sahilsait/' target='_blank' rel='norefferer'><i class="fa-brands fa-linkedin-in"></i></a>
        </div>
    </div>
</div>